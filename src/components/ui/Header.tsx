    ...
    <>
      ...
      <div className="gs-pill">
        ...
        <div className="gs-social">
          <a href="https://www.linkedin.com/in/gsymmy/" target="_blank" rel="noopener noreferrer me" className="gs-icon-btn" title="LinkedIn — Gursimran Singh">
          ...
          <a href="https://github.com/gsymmy30" target="_blank" rel="noopener noreferrer me" className="gs-icon-btn" title="GitHub — gsymmy30">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://x.com/gsymmy" target="_blank" rel="noopener noreferrer me" className="gs-icon-btn" title="X — @gsymmy">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="mailto:gsymmy@gmail.com" className="gs-icon-btn" rel="me" title="Email Gursimran Singh">
